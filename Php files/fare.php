...
<h2> Enter Following Details to View Fare Details </h2>
<form name="f1" action="fare2.php" method="get">
<p1>Train No. :</p1> <input type="text" name="i1" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="4"><br><br>
<p2>Date :</p2>  <input type="date" id="date"><br><br>
...
<p7> <input type="Submit" value="Get Fare" onclick="return call1()"> </p7>
<p8> <input type="Reset" value="Clear"> </p8> </form>
</body>
</html>